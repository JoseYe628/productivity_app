...
TodoItem _todoItemDeserialize(
  ...
  final object = TodoItem(
    checked: reader.readBool(offsets[0]),
...
extension TodoItemQueryWhereSort on QueryBuilder<TodoItem, TodoItem, QWhere> {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterWhere> anyOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQueryWhere on QueryBuilder<TodoItem, TodoItem, QWhereClause> {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterWhereClause> orderEqualTo(int order) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterWhereClause> orderNotEqualTo(
      int order) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterWhereClause> orderGreaterThan(
    int order, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterWhereClause> orderLessThan(
    int order, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterWhereClause> orderBetween(
    int lowerOrder,
    int upperOrder, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoItemQueryFilter
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> checkedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> orderEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'order',
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> orderGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> orderLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> orderBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoItemQuerySortBy on QueryBuilder<TodoItem, TodoItem, QSortBy> {
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByChecked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'checked', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByCheckedDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQuerySortThenBy
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByChecked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'checked', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByCheckedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'checked', Sort.desc);
    });
  }
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.desc);
    });
  }
...
extension TodoItemQueryWhereDistinct
  ...
  QueryBuilder<TodoItem, TodoItem, QDistinct> distinctByChecked() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QDistinct> distinctByOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQueryProperty
  ...
  QueryBuilder<TodoItem, bool, QQueryOperations> checkedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, int, QQueryOperations> orderProperty() {
    return QueryBuilder.apply(this, (query) {
